...
public class CsvStopRepositoryTest {
	...
	public void findsAll() {
		assertEquals(6535, stopRepository.findAll().size());
	}
	...
	public void findsSeulbergByLonLat() {
		assertEquals("Seulberg", stopRepository.findByLonLat(8.657660, 50.239804).getName());
	}

	@Test
	public void findsFrankfurtNiederradByLonLat() {
		assertEquals("8002050", stopRepository.findByLonLat(8.637075, 50.081283).getId());
	}
}
